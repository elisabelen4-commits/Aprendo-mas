...
import { CalculatorOutlined, PlayCircleOutlined, FileTextOutlined } from '@ant-design/icons';

const { Title, Paragraph } = Typography;

const ModuloMatematicas: React.FC = () => {
