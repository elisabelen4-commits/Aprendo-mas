...
import { GlobalOutlined, PlayCircleOutlined, FileTextOutlined } from '@ant-design/icons';

const { Title, Paragraph } = Typography;

const ModuloCienciasSociales: React.FC = () => {
  ...
  const opciones = [
    {
      ...
      color: '#fa8c16',
      ruta: '/ciencias-sociales/tutoriales'
    },
    {
      id: 'examenes',
      titulo: 'Exámenes',
      ...
      color: '#fa8c16',
      ruta: '/ciencias-sociales/examenes'
    }
  ];
    ...
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        <Space direction="vertical" align="center" size="large">
          <GlobalOutlined style={{ fontSize: '64px', color: '#fa8c16' }} />
          <div>
...
export default ModuloCienciasSociales;
